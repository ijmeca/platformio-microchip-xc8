	...
	; Compiler options:
	;
	; -q --opt=none --chip=12f675 \
	; --dfp=/Applications/microchip/mplabx/v5.45/packs/Microchip/PIC10-12Fxxx_DFP/1.3.46/xc8 \
	; --opt=+1 -ofirmware.elf --objdir=build --outdir=build main.c \
